     <?php
      if (isset($_GET['id'])) {
        ...
        $query = mysqli_query($koneksi, "SELECT * FROM sejarah WHERE id = '$id' ");
        while ($data = mysqli_fetch_array($query)) {
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="?page=aksi_edit_sejarah" method="POST" enctype="multipart/form-data">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="submit" class="btn btn-primary" value="Edit Sejarah" name="upload">
                  </div>
                </div>
