        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            ...
            <form action="function/aksi_login.php" method="post">
              ...
              <input type="submit" value="Log In" class="btn btn-block btn-primary" style="background-color: #3498db; border : none;">
