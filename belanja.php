        ...
        <div class="testimonials-slider swiper">
         ...
         <table class="table table-bordered">
            ...
            <?php
              ...
              $query = mysqli_query($koneksi, "SELECT * FROM keuangan WHERE status = 'Belanja' ");
            ...
            <tfoot>
                  <tr>
                    ...
                    <th>
                      <?php 
                        $query1 = mysqli_query($koneksi, "SELECT sebelum_perubahan FROM keuangan WHERE status = 'Belanja'");
                    ...
                    <th>
                      <?php 
                        $query2 = mysqli_query($koneksi, "SELECT sesudah_perubahaan FROM keuangan WHERE status = 'Belanja'");
